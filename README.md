...
The place to begin is the representation of physical phenomena as periodic information, starting in two dimensions as sound waves and following through into three dimensional particles as persistant standing wave patterns that make up our physical universe. This representation can be done conceptually in maths using differential equations, from simple linear ordinary differential equations (ODEs) that could describe atomic shell configurations, into complex non-linear partial differential equations (PDEs) that might describe motion in a body of water, likely with multiple flow velocities and different viscosities. At the most extreme form, a single equation might be able to describe the entire universe, for example reaction-diffusion equations can give rise to cell like growth.
